...
for ($i = 0; $i < count($tmp); $i++) {
    if ($tmp[$i] != '') {
        ...
        $exe_path_info = ssh2_exec($connection, $mmlsattr_cmd_prefix + $pathinfo);
        ...
        $exe_tier_info = ssh2_exec($connection, $mmlsattr_cmd_prefix + $pool_info);
        ...
        $exe_crtime_info = ssh2_exec($connection, $mmlsattr_cmd_prefix + $crtime_info);
        ...
        $exe_modtime = ssh2_exec($connection, $stat_cmd_prefix + $modtime_info);
        ...
        $exe_filesize = ssh2_exec($connection, $stat_cmd_prefix + $filesize_info);
